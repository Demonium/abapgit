class ZCL_Z_CBTGW_CUSTOMER_MPC definition
  public
...
public section.
  ...
  types:
     TS_CUSTOMER type ZCBT_S_CUSTOMER .
  types:
...
CLASS ZCL_Z_CBTGW_CUSTOMER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_CBTGW_CUSTOMER_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'CustomerNb' iv_abap_fieldname = 'CUSTOMER' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Postlcode' iv_abap_fieldname = 'POSTLCODE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Searchterm' iv_abap_fieldname = 'SEARCHTERM' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCBT_S_CUSTOMER'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180924152039'.                  "#EC NOTEXT
